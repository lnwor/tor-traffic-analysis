...
def generate_shadow():
    ...
    for i in range(args.servers[0]):
        ...
        shadow["hosts"]["fileserver" + str(i)]["network_node_id"] = 0
    ...
    shadow["hosts"]["4uthority"]["network_node_id"] = 0
    shadow["hosts"]["4uthority"]["ip_addr"] = "100.0.0.1"
    ...
    shadow["hosts"]["exit1"] = {}
    shadow["hosts"]["exit1"]["network_node_id"] = 0
    ...
    shadow["hosts"]["exit2"] = {}
    shadow["hosts"]["exit2"]["network_node_id"] = 0
    ...
    shadow["hosts"]["relay1"] = {}
    shadow["hosts"]["relay1"]["network_node_id"] = 0
    ...
    shadow["hosts"]["relay2"] = {}
    shadow["hosts"]["relay2"]["network_node_id"] = 0
    ...
    for i in range(args.clients[0]):
        ...
        shadow["hosts"]["torclient" + str(i)]["network_node_id"] = 0
        ...
        with open("./conf/tgen.torclient.graphml.xml", "r") as f:
            ...
            for line in lines:
                ...
                #     fout.write('      <data key="d0">'+str(random.randint(1,10))+'</data>\n')
                else:
                    fout.write(line)
            fout.close()
